...
export function HeroSection() {
    ...
    return (
        <>
            <HeroHeader onOpenSignUpDialog={() => setShowSignUpDialog(true)} />
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        href="#link"
                                        className="hover:bg-background dark:hover:border-t-border bg-muted group mx-auto flex w-fit items-center gap-4 rounded-full border p-1 pr-4 shadow-md shadow-black/5 transition-all duration-300 dark:border-t-white/5 dark:shadow-zinc-950">
                                        <span className="text-foreground text-sm">پشتیبانی از مدل‌های هوش مصنوعی</span>
                                        <span className="dark:border-background block h-4 w-0.5 border-r bg-white dark:bg-zinc-700"></span>

                                        <div className="bg-background group-hover:bg-muted size-6 overflow-hidden rounded-full duration-500">
                                            <div className="flex w-12 translate-x-1/2 duration-500 ease-in-out group-hover:translate-x-0">
                                                <span className="flex size-6">
                                                    <ArrowRight className="m-auto size-3 rotate-180" />
                                                </span>
                                                <span className="flex size-6">
                                                    <ArrowRight className="m-auto size-3 rotate-180" />
                                                </span>
                                    ...
                                    <h1
                                        className="mt-8 max-w-4xl mx-auto text-balance text-5xl md:text-6xl lg:mt-16 xl:text-7xl">
                                        مدیریت و نگهداری هوشمند تجهیزات
                                    </h1>
                                    <p
                                        className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                                        نرم‌افزار قدرتمند CMMS که به شما کمک می‌کند تا عملیات نگهداری خود را ردیابی، مدیریت و بهینه‌سازی کنید و در عین حال زمان خرابی را کاهش و عمر تجهیزات را افزایش دهید.
                                    </p>
                                </AnimatedGroup>
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        <Button
                                            ...
                                            <span className="text-nowrap">شروع دوره آزمایشی رایگان</span>
                                        </Button>
                                    </div>
                                </AnimatedGroup>
                            </div>
                    ...
                    <div className="group relative m-auto max-w-5xl px-6">
                        <div className="absolute inset-0 z-10 flex scale-95 items-center justify-center opacity-0 duration-500 group-hover:scale-100 group-hover:opacity-100">
                            <Link
                                ...
                                <span>آشنایی با مشتریان ما</span>
...
const HeroHeader = ({ onOpenSignUpDialog }: HeroHeaderProps) => {
            ...
            <nav
                ...
                <div className={cn('mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 lg:px-12', isScrolled && 'bg-background/50 max-w-4xl rounded-2xl border backdrop-blur-lg lg:px-5')}>
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        ...
                        <div className="bg-background group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-start space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
                            <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                                ...
                                <Button
                                    ...
                                    <span>شروع دوره آزمایشی رایگان</span>
                                </Button>
                            </div>
                        </div>
                    </div>
