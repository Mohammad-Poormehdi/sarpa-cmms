...
export function AnimatedAIChat() {
    ...
    const commandSuggestions: CommandSuggestion[] = [
        { 
            ...
            label: "ثبت درخواست تعمیرات", 
            description: "ثبت یک درخواست جدید برای تعمیرات تجهیزات", 
            prefix: "/request" 
        },
        { 
            icon: <CircleUserRound className="w-4 h-4" />, 
            label: "وضعیت تجهیزات", 
            description: "مشاهده وضعیت فعلی تجهیزات و دارایی‌ها", 
            prefix: "/asset" 
        },
        { 
            icon: <MonitorIcon className="w-4 h-4" />, 
            label: "برنامه‌ریزی نگهداری", 
            description: "زمان‌بندی فعالیت‌های نگهداری پیشگیرانه", 
            prefix: "/schedule" 
        },
        { 
            icon: <Sparkles className="w-4 h-4" />, 
            label: "دستورکارها", 
            description: "مشاهده و مدیریت دستورکارهای فعال", 
            prefix: "/workorder" 
        },
    ];
                    ...
                    <div className="text-center space-y-3">
                        ...
                        >
                            <h1 className="text-3xl font-medium tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white/90 to-white/40 pb-1">
                                دستیار هوشمند مدیریت نگهداری و تعمیرات
                            </h1>
                            <motion.div 
                        ...
                        >
                            برای درخواست تعمیرات، بررسی وضعیت تجهیزات یا کمک با سامانه سوال بپرسید
                        </motion.p>
                    </div>
                    ...
                    >
                        ...
                        <div className="p-4">
                            <Textarea
                                ...
                                placeholder="مشکل یا درخواست خود را وارد کنید..."
                    ...
                    >
                        <div className="flex items-center gap-3">
                            <div className="w-8 h-7 rounded-full bg-white/[0.05] flex items-center justify-center text-center">
                                <span className="text-xs font-medium text-white/90 mb-0.5">سرپا</span>
                            </div>
